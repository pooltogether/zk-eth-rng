...
contract VDFProvider is IRandomnessProvider {
  ...
  constructor(
    IFactRegistry _factRegistry,
    IRandomnessProvider _randaoProvider,
    uint256 _nIterations
  ) {
  ...
  function fetchRandomness(
    uint256 blockNum,
    uint256 numberRandomValues
  ...
  function generateMoreRandomValues(
    uint256 seed,
    uint256 numRandomValues
